...
class TicTacToeApp:
    ...
    def create_widgets(self):
        ...
        self.status_label = tk.Label(self.root, text="Player O's turn", font=('normal', 20))
        self.status_label.grid(row=3, column=0, columnspan=3)
        self.reset_button = tk.Button(self.root, text="Reset", font=('normal', 20), command=self.reset_board)
